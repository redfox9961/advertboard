...
namespace AdvertBoardUI.Controllers
{
    ...
    public class ManageController : Controller
    {
        ...
        public ApplicationSignInService SignInManager
        {
            get
            {
        ...
        //        PhoneNumber = await _userService.GetPhoneNumberAsync(userId),
        //        TwoFactor = await _userService.GetTwoFactorEnabledAsync(userId),
        //        Logins = await _userService.GetLoginsAsync(userId),
